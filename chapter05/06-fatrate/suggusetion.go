...
func GetFaRateSuggestion() *fatRateSuggestion {
...
func (s *fatRateSuggestion) GetSuggestion(person *Person) string {
	...
	suggIdx := s.suggArr[sexIdx][ageIdx][int(person.fatRate*100)]
	return s.translatResult(suggIdx)
	return "TODO"
}
...
func (s *fatRateSuggestion) translatResult(idx int) string {
	switch idx {
	case 0:
		return "偏瘦"
	case 1:
